module.exports = {
    ...
    "rules": {
      ...
      "no-unused-expressions": ["error", { "allowTernary": true, "allowShortCircuit": true }], // disallow usage of expressions in statement position
      ...
      "no-multiple-empty-lines": [1, {"max": 1}], // disallow multiple empty lines (off by default)
